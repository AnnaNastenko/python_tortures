...
sum1 = round(halo + enjoy_the_silence + clean, 2)
print("three songs last: ", sum1, "minutes")
...
# TODO здесь ваш код
sweetest_perfection = violator_songs_dict.get('Sweetest Perfection')
policy_of_truth = violator_songs_dict.get('Policy of Truth')
blue_dress = violator_songs_dict.get('Blue Dress')
